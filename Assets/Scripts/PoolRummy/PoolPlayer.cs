...
public class PoolPlayer : MonoBehaviourPun
{
    ...
    IEnumerator selectDragCard_coroutin(Card _card)
    {
        ...
        if (selectedCard != null)
        {
            if (selectedCard == _card)
            {
                ...
                PoolRummyManager.instance.discardButton.gameObject.SetActive(false);
            }
            else
            {
    ...
    {
        if (PoolRummyManager.instance.GetActivePlayer.turnState == PlayerState.hasDrawn)
            PoolRummyManager.instance.discardButton.gameObject.SetActive(true);
        else
            PoolRummyManager.instance.discardButton.gameObject.SetActive(false);
    }
    ...
    public void PlayTurn(Card _card)
    {
        ...
        PoolRummyManager.instance.DeckBoundryGlow.SetActive(false);
    }
