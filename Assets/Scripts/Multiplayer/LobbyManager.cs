...
public class LobbyManager : MonoBehaviourPunCallbacks, IPunOwnershipCallbacks, IPunObservable
{
    ...
    public Vector2 second5PlayerButFourthElement;
    public Vector2 fifth5player;
   

    public Vector2 active6player;
    public Vector2 third6player;
    ...
    void distirbuteCard()
    {
        ...
        RummyManager.instance.totalPlayers = PhotonNetwork.PlayerList.Length;
        RummyManager.instance.shuffleDeck();
        RummyManager.instance.DrawWildCard();
    ...
    void setOwnership_RPC()
    {
        ...
        {
            RummyManager.instance.PlayerList[i].GetComponent<PhotonView>().TransferOwnership(PhotonNetwork.PlayerList[i]);

            if(PhotonNetwork.LocalPlayer == PhotonNetwork.PlayerList[i])
                RummyManager.instance.setActivePlayer(i);
        }     
    }
    ...
    public void setPlayerPosAndGem()
    {
        ...
        RummyManager.instance.distibutingAnimation(PhotonNetwork.PlayerList.Length);
    }
    ...
    void setPlayergemFor2Players()
    {
        ...
        {
            if (RummyManager.instance.PlayerList[i] == RummyManager.instance.GetActivePlayer)
                setPlayergemFor(i, 0);
            else
                setPlayergemFor(i, 1);
        }
    ...
    void setPlayergemFor5Players()
    {
        ...
        //rearrangin the seat
        playerGemsList[0].GetComponent<RectTransform>().anchoredPosition = active2player;
        playerGemsList[3].GetComponent<RectTransform>().anchoredPosition = second5PlayerButFourthElement;
        playerGemsList[1].GetComponent<RectTransform>().anchoredPosition = second3player;
        playerGemsList[2].GetComponent<RectTransform>().anchoredPosition = third3player;
        playerGemsList[4].GetComponent<RectTransform>().anchoredPosition = fifth5player;
    }
    ...
    void setPlayergemFor(int playerIndexInPlayerList, int playerGemIndexInGemList)
    {
        ...
        RummyManager.instance.PlayerList[playerIndexInPlayerList].playerGem = playerGemsList[playerGemIndexInGemList];
        RummyManager.instance.PlayerList[playerIndexInPlayerList].inGamePlayerName = playerInGameTextList[playerGemIndexInGemList];
